...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ 
  ...
  <div className="flex flex-col gap-6">
    ...
    <div className="text-right"> {/* Changed from text-center to right align */}
      <p 
    ...
    <div className="text-right">
      <div className="flex flex-row-reverse items-center gap-2 mb-1 justify-start">
        <h4 className="font-bold text-[#181d27] text-lg">
          {name}
        </h4>
        {/* Blue checkmark */}
