                ...
                <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td style="text-align: center; padding-bottom: 50px;">
                            <img src="https://images.yaneah.com/Group%2030538.jpg" alt="يانعة" class="logo-image" height="70" width="229" style="display: block; margin: 0 auto;">
                        </td>
                    </tr>
                </table>
                        ...
                        <td class="main-content" style="padding: 30px;">
                            ...
                            ${
                              props.status === "accepted"
                                ...
                                <p style="color: #000000; font-size: 1.1rem; line-height: 1.8; text-align: center; margin: 20px 0;">
                                    يمكنك الآن تسجيل الدخول والبدء في استخدام حسابك عبر الرابط التالي: <a href="https://yaneah.com/login" style="color: #006173; text-decoration: none;">رابط تسجيل الدخول</a>.
                                </p>
                                <p style="color: #000000; font-size: 1.1rem; line-height: 1.8; text-align: center; margin: 20px 0;">
                            ...
                            `
                                ...
                                <p style="color: #000000; font-size: 1.1rem; line-height: 1.8; text-align: center; margin: 20px 0;">
                                    إذا كنت تعتقد أن هذا حدث عن طريق الخطأ، يرجى التواصل معنا عبر <a href="mailto:support@yaneah.com" style="color: #006173; text-decoration: none;">support@yaneah.com</a>.
                                </p>
                                <p style="color: #000000; font-size: 1.1rem; line-height: 1.8; text-align: center; margin: 20px 0;">
