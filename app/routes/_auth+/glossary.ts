const login = {
    ...
    errors: {
        ...
        unverified: "لم يتم تفعيل البريد الإلكتروني. الرجاء تفعيل حسابك أولاً",
        invalidCredentials: "البريد الإلكتروني أو كلمة المرور غير صحيحة",
        userNotFound: "لا يوجد حساب مسجل بهذا البريد الإلكتروني",
        wrongPassword: "كلمة المرور غير صحيحة",
        accountDeactivated: "تم إيقاف حسابك. يرجى التواصل مع الإدارة",
        accountPending: "حسابك قيد المراجعة. سيتم إعلامك عند الموافقة",
        accountDenied: "تم رفض طلب انضمامك للبرنامج",
        sessionFailure: "فشل في إنشاء جلسة تسجيل الدخول. الرجاء المحاولة مرة أخرى",
        networkError: "خطأ في الاتصال. الرجاء التحقق من الإنترنت والمحاولة مرة أخرى",
        serverError: "خطأ في الخادم. الرجاء المحاولة مرة أخرى بعد قليل",
        tooManyAttempts: "تم تسجيل محاولات دخول متعددة. الرجاء المحاولة مرة أخرى بعد قليل",
